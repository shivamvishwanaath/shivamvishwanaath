...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Centralized academic repository for Classes 1–12 and online testing engine.</li>
        <li>Designed real-time diagnostic recommendation algorithms that cluster conceptual blind spots.</li>
        <li>Hosted on bare-metal Ubuntu VPS with Caddy reverse proxy and PM2 clustering.</li>
      </ul>
      <p align="center">
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>Conflict-free interactive calendar scheduling with timezone synchronization.</li>
        <li>Visual syllabus milestone progress meters for students and parents.</li>
      </ul>
      <p align="center">
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>100% offline-first native Android utility with sub-10ms element lookups.</li>
        <li>Published on Google Play Store with <b>70+ five-star reviews</b>.</li>
        <li>Custom chemistry search algorithms and property visualization.</li>
      </ul>
      <p align="center">
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Customizable test simulation engine for JEE & NEET entrance aspirants.</li>
        <li>Separated Administrator CMS for question authoring and Student testing portal.</li>
        <li>Real-time national percentile and ranking projection engine.</li>
      </ul>
      <p align="center">
